...
```
pod 'WebimClientLibrary', :git => 'https://github.com/webim/webim-client-sdk-ios.git', :branch => 'master', :tag => '3.34.4'
```
...
```
github "webim/webim-client-sdk-ios" ~> 3.34.4
```
...
## Release notes
* Additional queue for history requests.
* Code refactoring.
